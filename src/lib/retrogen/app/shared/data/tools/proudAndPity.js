...
const tool = {
	...
	instruction: [
		`Попросите участников записать на стикерах что вызывает чувство гордости, а что чувство сожаления.`,
		`Каждая мысль записываеться на отдельном стикере.`,
		`Когда участники закончат писать, попросите озвучить свои записи и наклеить в соответствующую колонку.`,
		`Начните групповое обсуждение задавая следующие вопросы.`,
		`Вопрос: Что из озвученного удивило вас?`,
		`Вопрос: Какие выводы можно сделать?`,
		`Вопрос: Что это значит для нас, как для команды?`
	],
	listData: ['', '', ''],
	components: [
