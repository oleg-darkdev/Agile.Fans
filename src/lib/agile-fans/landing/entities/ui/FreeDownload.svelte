<div class="px-5 pb-24 lg:mx-0">
	<div
		class=" shadow-long mx-auto flex w-full max-w-6xl flex-col items-center justify-center overflow-hidden rounded-xl bg-gray-50 px-6 py-16 lg:px-12 lg:py-12"
	>
		<div
