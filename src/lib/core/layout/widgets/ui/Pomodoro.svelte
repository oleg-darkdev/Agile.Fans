<script>
	...
	import { showNotification, playSound, minutsAndSecondsToSecondsConverter } from '@coreSharedUtils';
	import { CountdownTime } from '../../entities';
// ../../stores/settings
	import { currentView } from '@coreSharedData';
	import { Button } from '@coreSharedLayout';
