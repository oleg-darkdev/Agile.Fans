...
>
	...
	>
		...
		>
			...
			<div class="mt-4">
				<label class="text-sm text-gray-700 " for="share link">Share link</label>
			...
			<div class="mt-0 mt-4 flex justify-center gap-2 sm:-mx-2 sm:mt-6 sm:items-center lg:mt-6">
