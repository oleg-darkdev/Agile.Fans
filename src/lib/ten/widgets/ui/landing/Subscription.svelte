<section class="dark:bg-wickeddark w-full bg-white">
	<div class="relative mx-auto w-full max-w-7xl items-center px-5 py-12 md:px-12 lg:px-16 lg:py-24">
			...
			<div class="relative mx-auto inline-flex items-center align-middle">
				<div class="pb-12 text-center">
					...
					<form
						...
						name="revue-form"
						target="_blank"
						class="border2 mt-8 transform rounded-xl bg-gray-50 p-2 transition duration-500 ease-in-out sm:flex sm:max-w-lg md:mx-auto"
					>
						...
						<div class="revue-form-actions mt-4 sm:mt-0 sm:ml-3">
							<button
								type="submit"
								value="Subscribe"
								name="member[subscribe]"
								id="member_submit"
								class="block w-full rounded-lg border border-transparent bg-blue-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10"
								>Notify me</button
							>
						</div>
					</form>
