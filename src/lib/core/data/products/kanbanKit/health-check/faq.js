const faq = {
	categoryTitle: 'Gra:  Health-check',

	content: [
		{
			title: 'What are team health checks?',
			desc: [
		...
		{
			title: 'Shouldn`t I do a workshop with the team instead of a survey?',
			desc: [
				`The <a
		...
		{
			title: 'How are the results calculated?',
			desc: [
				`Like an <a
					href="https://engineering.atspotify.com/2014/09/squad-health-check-model/"
					class="mt-4 inline-flex items-center font-semibold text-pink-600 hover:text-white lg:mb-0"
		...
		{
			title: 'Is there a baseline I can compare my team to?',
			desc: [
