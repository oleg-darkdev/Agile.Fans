...
<div
	class="bg-neutal-600  flex h-full flex-row flex-wrap justify-around rounded-lg border-2 border border-neutral-600 p-1 text-gray-500 shadow-md  shadow-neutral-700 hover:bg-neutral-900 "
>
