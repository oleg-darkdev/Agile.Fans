<aside class="flex">
	<div
		class="flex h-screen w-16 flex-col items-center bg-white py-8 dark:border-gray-700 dark:bg-gray-900"
	>
		<nav class="flex flex-1 flex-col items-center space-y-8 ">
			...
			<a
				href="#"
				class="inline-block rounded-lg bg-blue-100 p-1.5 text-blue-500 transition-colors duration-200 dark:bg-gray-800 dark:text-blue-400"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
	...
	<div
		class="h-screen w-60 overflow-y-auto border-l border-r bg-white px-5 py-8 dark:border-gray-700 dark:bg-gray-900 sm:w-64"
	>
		<div class="relative">
		...
		<nav class="-mx-3 mt-4 space-y-6 ">
			<div class="space-y-3 ">
				<label class="px-3 text-xs uppercase text-gray-500 dark:text-gray-400">analytics</label>
			...
			<div class="space-y-3 ">
				<label class="px-3 text-xs uppercase text-gray-500 dark:text-gray-400">content</label>
			...
			<div class="space-y-3 ">
				<label class="px-3 text-xs uppercase text-gray-500 dark:text-gray-400">Customization</label>
