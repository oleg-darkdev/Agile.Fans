...
const tool = {
	...
	instruction: [`Дайте участникам 10 минут, чтобы записать памятные и для них значимые события.`, `Все участиники выкладывают или приклеивают свои карточки на хронологически подходящую позицию.`,
		`Можно и сейчас добавлять новые карточки.`,
		`Анализируйте сформировавшуюся картину.`, 		`Можно использовать карточки разных цветов чтобы распознать закономерности, например: Чувства/Эмоции, События (технические, организационные, ..), Функции (тестер, разработчик, менеджер, ...)`,
 ``, ``, ``, ``],
	listData: ['', '', ''],
	components: [
		{
